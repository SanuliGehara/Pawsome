...
class Terms extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// Scrollable body in case content is long
...
/// A reusable card that expands to show detailed content
class TermsCard extends StatefulWidget {
  final String title; // Title of the section
  final String content; // Detailed description
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        onExpansionChanged: (expanded) {
          /// Update UI when tile is expanded or collapsed
          setState(() {
            isExpanded = expanded;
          });
        },
